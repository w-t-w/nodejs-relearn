function Item({column}) {
    return <div className="_20Cq3Rn7_0">
        ...
        <div className="_3M3E-ESU_0">
            ...
            <div className="_2zRFFX7P_0">
                <p className="_14cxbu2p_0"><span
                    className="_1BSc9YvC_0">限时 ¥{column.column_price / 100}</span>{column.column_price_market ?
                    <s className="_1EwQIhcU_0">原价 ¥{column.column_price_market / 100}</s> : ''}</p>
